...
namespace Softblue
{
    ...
    partial class Survey : IStorable
    {
        ...
        /// <summary>
        /// Referencia objeto reponsável por calcular os voltos.
        /// </summary>
        private Votes votes;
        ...
        public Survey()
        {
            //Instancia o bbjeto que calcula os votos.
        ...
        {
            // Carrega a quetão da enquete e depois cada uma das opções.
