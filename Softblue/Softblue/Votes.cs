    ...
    partial class Survey
    {
        ...
        private class Votes : IStorable
        {
            ...
            public void AddVote(Option option)
            {
                ...
                {
                    // Se a opção ainda não havia sedo votada, considera 1 voto.
                    votes[option] = 1;
                }
            ...
            /// </summary>
            /// <param name="sort">Indica se deve haver ordenação por ordem decrescente de votos. O padrâo é true.</param>
            ...
            public List<OptionScore> CalculateScores(bool sort = true)
            {
                ...
                // Ordena a lsita se for necessário
                if (sort) scores.Sort();
            ...
            public void Save(BinaryWriter writer)
            {
                ...
                foreach (KeyValuePair<Option, int> entry in votes)
                {
                    ...
                    // Chama o Sava() de Option para gravar a opção.
                    option.Save(writer);
            ...
            public void Load(BinaryReader reader)
            {
                ...
                // Intera criando as opções e seus respctivos votos.
