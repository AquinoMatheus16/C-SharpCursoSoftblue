    ...
    class SurveyUI
    {
        ...
        public void Start()
        {
            while (true)
            {
                ...
                if (option == "1")
                {
                    // Cria uma enquete e mostar o menu de enquete.
                    ShowCreateMenu();
                    ShowSurveyMenu();
                }
                else if (option == "2")
        ...
        private void ShowCreateMenu()
        {
            ...
            // Solicita cada uma das opções (ID  etexto).
            for (int i = 0; i < numOptions; i++)
            {
                ...
                while (true)
                {
                    Console.Write("Texto da opção {}: ", i + 1);
            ...
            Console.WriteLine("Enquete salvaem \"{0}\". Pressione ENTER para continuar...", surveyFile);
            Console.WriteLine();
        }

        /// <summary>
        /// Mosntra o menu de votação na enquete.
        /// </summary>
        private void ShowLoadMenu()
        {
            ...
            while (true)
            {
                ...
                Console.Write("Digete o nome do arquivo da enquete: ");
                string filePath = Console.ReadLine();
                if (!String.IsNullOrEmpty(filePath))
                {
                    try
                    {
                        ...
                        surveyFile = filePath;
                        Console.Write("A enquete foi carregada com suceso! Pressione ENTER para continuar...");
                        Console.ReadLine();
                        break;
                    }
                    catch (IOException e)
        ...
        private void ShowVoteMenu()
        {
            ...
            // Ao final da votação, valva a enquete no arquivo associado.
        ...
        /// <summary>
        /// Mostrar o menu de enquete, onde é possível votar ou ver o resultado.
        /// </summary>
