    ...
    class Game
    {
        ...
        private void ReadPlayerNames()
        {
            ...
            while (true)
            {
                ...
                {
                    // Se for iqual ao nome do primeiro jogador, solicita novamente.
            ...
            // Cria os jogadores.
            players[0] = new Player(player1Name, ConsoleColor.DarkBlue, BoardItem.X);
            players[1] = new Player(player2Name, ConsoleColor.Cyan, BoardItem.O);
        }
        ...
        {
            // Lê o próximo índece como se a lista fosse circular.
        ...
        private void ProcessPlay(string play, Player player)
        {
            ...
            try
            {
                ...
                {
                    throw new PlayException("Os índices utilizados estão foro do intervalo permitido");
                }
