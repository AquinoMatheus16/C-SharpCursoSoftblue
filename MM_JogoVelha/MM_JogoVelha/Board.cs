...
namespace Softblue
{
    ...
    class Board
    {
        ...
        /// </summary>
        /// <param name="winnerBoardItem">Praâmetro de saída, que indica BoardItem ganha (se houver um).</param>
        ...
        /// </summary>
        /// <returns>O item que faz parte da sequência ou null se não existe sequência.</returns>
